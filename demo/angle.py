...
initial_angle_times = {}
angle_choice_single(structure, initial_angle_times, angle_range, points, time, save_path, 'angle_choice_1')

# Investigate second angle choice.
initial_angle_times = {2.3: (70, 20)} # First first angle choice - Angle: (Points, Time)
angle_choice_single(structure, initial_angle_times, angle_range, points, time, save_path, 'angle_choice_2')

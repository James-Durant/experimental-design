...
class Optimiser:
    ...
    def optimise_angle_times(self, num_angles, contrasts=[], total_time=1000, points=100, angle_bounds=(0.2, 2.3)):
        ...
        res = Optimiser.__optimise(Optimiser._angle_times_func, bounds, constraints, args)
    ...
    def optimise_contrasts(self, num_contrasts, angle_times, contrast_bounds=(-0.56, 6.36)):
        ...
        return Optimiser.__optimise(Optimiser._contrasts_func, bounds, [], args)
    ...
    @staticmethod
    def __optimise(func, bounds, constraints, args):

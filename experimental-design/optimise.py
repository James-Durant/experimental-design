...
class Optimiser:
    ...
    def optimise_angle_times(self, num_angles, contrasts=[], total_time=1000,
        ...
        """Optimises the measurement angles and associated counting times
           for an experiment, given a fixed time budget.
    ...
    def optimise_contrasts(self, num_contrasts, angle_splits,
                           ...
                           workers=-1, verbose=True):
        """Finds the optimal contrasts for an experiment, given a fixed time budget.
        ...
        # Define the bounds on each condition to optimise (contrast SLDs and time splits).
    ...
    def optimise_underlayers(self, num_underlayers, angle_times, contrasts,
                             ...
                             workers=-1, verbose=True):
        """Finds the optimal underlayer thicknesses and SLDs for an experiment.
        ...
        Args:
            ...
            thick_bounds (tuple): interval containing underlayer thicknesses to consider.
            sld_bounds (tuple): interval containing underlayer SLDs to consider.
            workers (int): number of CPU cores to use when optimising.
            verbose (bool): whether to display progress or not.
    ...
    def _underlayers_func(self, x, num_underlayers, angle_times, contrasts):
        ...
        Args:
            x (list): underlayer thicknesses and SLDs to calculate the function with.
